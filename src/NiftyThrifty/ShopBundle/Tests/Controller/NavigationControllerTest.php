...
class NavigationControllerTest extends NiftyBaseTestCase
{
    ...
    private function _assertActiveCollections($crawler)
    {
        ...
        $this->assertEquals($collectionNodes->eq(2)->attr('id'),  'coll2');
        $this->assertCount(1, $collectionNodes->eq(2)->children());
        $this->assertEquals($collectionNodes->eq(2)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-two-2');
        $this->assertEquals($collectionNodes->eq(2)->children()->eq(0)->text(), 'Active Not Ending Soon Two');

        $this->assertEquals($collectionNodes->eq(3)->attr('id'),  'coll3');
        $this->assertCount(1, $collectionNodes->eq(3)->children());
        $this->assertEquals($collectionNodes->eq(3)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-three-3');
        $this->assertEquals($collectionNodes->eq(3)->children()->eq(0)->text(), 'Active Not Ending Soon Three');

        $this->assertEquals($collectionNodes->eq(4)->attr('id'),  'coll1');
        $this->assertCount(1, $collectionNodes->eq(4)->children());
        $this->assertEquals($collectionNodes->eq(4)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-one-1');
        $this->assertEquals($collectionNodes->eq(4)->children()->eq(0)->text(), 'Active Not Ending Soon One');
        ...
        $this->assertEquals($collectionNodes->eq(6)->attr('id'),  'coll4');
        $this->assertCount(1, $collectionNodes->eq(6)->children());
        $this->assertEquals($collectionNodes->eq(6)->children()->eq(0)->attr('href'), '/shop/show_collection/active-ending-soon-one-4');
        $this->assertEquals($collectionNodes->eq(6)->children()->eq(0)->text(), 'Active Ending Soon One');

        $this->assertEquals($collectionNodes->eq(7)->attr('id'),  'coll5');
        $this->assertCount(1, $collectionNodes->eq(7)->children());
        $this->assertEquals($collectionNodes->eq(7)->children()->eq(0)->attr('href'), '/shop/show_collection/active-ending-soon-two-5');
        $this->assertEquals($collectionNodes->eq(7)->children()->eq(0)->text(), 'Active Ending Soon Two');
    }
    ...
    private function _assertEndingSoonCollections($crawler)
    {
        ...
        $this->assertEquals($collectionNodes->eq(0)->attr('id'),  'coll5');
        $this->assertCount(1, $collectionNodes->eq(0)->children());
        $this->assertEquals($collectionNodes->eq(0)->children()->eq(0)->attr('href'), '/shop/show_collection/active-ending-soon-two-5');
        $this->assertEquals($collectionNodes->eq(0)->children()->eq(0)->text(), 'Active Ending Soon Two');

        $this->assertEquals($collectionNodes->eq(1)->attr('id'),  'coll4');
        $this->assertCount(1, $collectionNodes->eq(1)->children());
        $this->assertEquals($collectionNodes->eq(1)->children()->eq(0)->attr('href'), '/shop/show_collection/active-ending-soon-one-4');
        $this->assertEquals($collectionNodes->eq(1)->children()->eq(0)->text(), 'Active Ending Soon One');
        ...
        $this->assertEquals($collectionNodes->eq(3)->attr('id'),  'coll1');
        $this->assertCount(1, $collectionNodes->eq(3)->children());
        $this->assertEquals($collectionNodes->eq(3)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-one-1');
        $this->assertEquals($collectionNodes->eq(3)->children()->eq(0)->text(), 'Active Not Ending Soon One');
        
        $this->assertEquals($collectionNodes->eq(4)->attr('id'),  'coll3');
        $this->assertCount(1, $collectionNodes->eq(4)->children());
        $this->assertEquals($collectionNodes->eq(4)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-three-3');
        $this->assertEquals($collectionNodes->eq(4)->children()->eq(0)->text(), 'Active Not Ending Soon Three');

        $this->assertEquals($collectionNodes->eq(5)->attr('id'),  'coll2');
        $this->assertCount(1, $collectionNodes->eq(5)->children());
        $this->assertEquals($collectionNodes->eq(5)->children()->eq(0)->attr('href'), '/shop/show_collection/active-not-ending-soon-two-2');
        $this->assertEquals($collectionNodes->eq(5)->children()->eq(0)->text(), 'Active Not Ending Soon Two');
